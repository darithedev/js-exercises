...
var dreamDestination = "Costa Rica";
...
// EXPLAINATION: The difference between the rules for num1 and num2 from the exersice is that num2 can be equal to 1 or 10 while num1 cannot. (<=, >= vs <, >)
// The valdid values for num2 is 1 - 10, while num1 is 2 - 9 because num2 can be >= 1 and <= 10, meaning a number between and including 1 and 10. 
...
var statement = hi.concat(myName, ", and I can't wair to visit ", dreamDestination, "!");
...
const myAnswerForExercise12 = "string"; // if var emptyVariable = ""; otherwise undefine if var emptyVariable;
...
const myAnswerForExercise16 = "R"; // Wrong, console log show NaN

// Exercise 17 What is the value of true || false
const myAnswerForExercise17 = "true"; // tricky 
...
// EXPLAINATION: I found this fairly easy. Though exersizes 16-22 were tricky for me. I used the console to check if my answers were correct. 
