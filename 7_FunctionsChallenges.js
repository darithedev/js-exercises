...
// Exercise 6. Write a function called includes which accepts a collection, a value, 
// and an optional starting index. The function should return true if the value exists 
// in the collection when we search starting from the starting index. Otherwise, it should return false.
...
function includes (col, val, index) {
  let len = col.length;
