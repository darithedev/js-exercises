...
// ANSWER:
// One unexpected cases where varA and varB seemed like they are equal, but would not pass the tests are
// when one is a number and the other is a string of a number (i.e. '3'). If I were to pass boolean types
// they would fail even though both are boolean types because the frunction is only testing for strings or 
// number types. If I change the if statement to if (typeof varA === typeof varB) then as long as they are 
// the same data type they would be equal. 
