        ...
        <div className="App">
            <header className="App-header">
                <p>
                    ...
                    <input type="range" min="0" max="100" onChange={handleOSizeChange} />
                </p>
                ...
                <p>
                    ...
                    <button onClick={() => setColor("#d65fca")}>Pink</button>
                    <button onClick={() => setColor("#29bd2e")}>Green</button>
                    <button onClick={() => setColor("#d1d117")}>Yellow</button>
                </p>
            </header>
        </div>
    );
